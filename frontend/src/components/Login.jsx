      ...
      <div style={{ width: '380px', maxWidth: '95vw' }}>
        ...
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: '14px', padding: '32px' }}>
          ...
          {!showReset ? <>
            ...
            <div style={{ fontSize: '13px', color: 'var(--text-dim)', marginBottom: '24px' }}>Introduceți emailul asociat contului. Veți primi o parolă temporară.</div>
            {resetMsg && (
            ...
            <form onSubmit={handleReset}>
              ...
              <input type="email" value={resetEmail} onChange={e => setResetEmail(e.target.value)}
                placeholder="adresa@email.com" style={{ ...inputStyle, marginBottom: '18px' }}
                onFocus={e => e.target.style.borderColor = 'var(--accent)'}
                onBlur={e => e.target.style.borderColor = 'var(--border)'}
                autoComplete="email" />
